    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('image')->label('Картинка')->image()->directory('customers'),
                Forms\Components\FileUpload::make('image_white')->label('Картинка белая')->image()->directory('customers'),
