                ...
                <div class="tab-top-padding">
                    <div class="tab-top">
                        <div class="tab-top__wrapper">
                            <button type="button" class="tab-top__item js-tab-btn active" tabindex="1" title="All"
                                data-index="0">
                                All
                            </button>
                            <button type="button" class="tab-top__item js-tab-btn" tabindex="1" title="Clutch.co"
                                data-index="1">
                                Clutch.co </button>
                            <button type="button" class="tab-top__item js-tab-btn" tabindex="2" title="IT-rating.ua"
                                data-index="2">
                                IT-rating.ua </button>
    ...
    <section class="section-bg-black section-tech" id="section-tech">
        ...
        <div class="container">
            ...
            <div class="tab-block js-tab">
                ...
                <div class="tab-top">
                    <div class="tab-top__wrapper">
                        <button type="button" class="tab-top__item js-tab-btn active" tabindex="0" title="Frameworks"
                            data-index="0">
                            Frameworks </button>
                        <button type="button" class="tab-top__item js-tab-btn active" tabindex="1" title="Languages"
                            data-index="1">
                            Languages </button>
        ...
        <div class="container">
            ...
            <div class="case-top">
                <div class="section-name">
                    ...
                    <div class="btn-wrapper">
                        <a href="/cases" class="btn btn-tertiary btn-icon-right icon-arrow-right-top">view all
                            Cases</a>
                    </div>
                </div>
