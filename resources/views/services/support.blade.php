...
@section('description', 'Technical Support is the process of providing assistance to users of technology products, such
    as mobile phones, computers, and software applications')
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="feature-main__text">
                                    <p>
                                        Tasks must be created in the <span
                                            class="fake-link">https://trello.com/system</span>.
                                        If a task is not
                                ...
                                <picture>
                                    ...
                                    <img src="/img/services/tech-support-feature-1.png" loading="lazy"
                                        alt="Technical support - photo 15">
                                </picture>
                            </div>
                            <div class="swiper-slide">
                                ...
                                <picture>
                                    ...
                                    <img src="/img/services/tech-support-feature-2.png" loading="lazy"
                                        alt="Technical support - photo 16">
                                </picture>
                            ...
                            <div class="swiper-slide">
                                ...
                                <picture>
                                    ...
                                    <img src="/img/services/tech-support-feature-3.png" loading="lazy"
                                        alt="Technical support - photo 17">
                                </picture>
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="feature-main__text">
                                    ...
                                    <a style="color: white;" href="{{ route('form', app()->getLocale()) }}" class="btn btn-primary">
