            ...
            <div class="case-header__content">
                <div class="case-header__info">
                    ...
                    <div class="description">
                        <p>Lorem ipsum dolor sit amet consectetur. Ultrices tortor dictum habitant ultrices ut sed. Sed arcu
                            viverra ut ut. </p>
                    </div>
                </div>
            </div>
    ...
    <div class="blog-catalog">
        <div class="container">
            <div class="blog-filters">
                ...
                <button type="button" class="btn btn-primary btn-icon btn-filter _js-btn-modal"
                    data-modal="_js-modal-filters">
                ...
                <div class="modal filters _js-modal _js-modal-filters">
                    <div class="modal-content">
                        ...
                        <div class="filters-content">
                            ...
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-1" name="category[]"
                                    value="val-1">
                                <label for="category-1" class="form-label">Design tools</label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-2" name="category[]"
                                    value="val-2">
                                <label for="category-2" class="form-label">News</label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-3" name="category[]"
                                    value="val-3">
                                <label for="category-3" class="form-label">Software</label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-4" name="category[]"
                                    value="val-4">
                                <label for="category-4" class="form-label">Innovations</label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-5" name="category[]"
                                    value="val-5">
                                <label for="category-5" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-6" name="category[]"
                                    value="val-6">
                                <label for="category-6" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-7" name="category[]"
                                    value="val-7">
                                <label for="category-7" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-8" name="category[]"
                                    value="val-8">
                                <label for="category-8" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-9" name="category[]"
                                    value="val-9">
                                <label for="category-9" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-10" name="category[]"
                                    value="val-10">
                                <label for="category-10" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-11" name="category[]"
                                    value="val-11">
                                <label for="category-11" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-12" name="category[]"
                                    value="val-11">
                                <label for="category-12" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-13" name="category[]"
                                    value="val-11">
                                <label for="category-13" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-14" name="category[]"
                                    value="val-11">
                                <label for="category-14" class="form-label">Lorem ipsum </label>
                            </div>
                            <div class="form-group checkbox">
                                <input class="form-control" type="checkbox" id="category-15" name="category[]"
                                    value="val-11">
